  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at top right, rgba(57,255,20,0.04) 0%, transparent 70%)",
        }}
      />
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            <SectionReveal delay={0.1}>
              <div className="space-y-5 text-base md:text-lg leading-relaxed text-[var(--color-text-secondary)]">
                <p>
              ...
              {highlights.map((item, i) => (
                <SectionReveal key={item.title} delay={0.2 + i * 0.08}>
                  <div className="card-box flex gap-5 items-start">
                    ...
                    <div>
                      <h4
                        className="text-base font-semibold mb-1 font-display"
            ...
            <SectionReveal delay={0.25}>
              <div className="card-box space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-xs font-bold px-2 py-1 rounded-md" style={{ background: "var(--color-accent-dim)", color: "var(--color-accent)" }}>
                    Year 3 of 4 · 75%
                  </span>
                </div>
                ...
                >
                  <div
                    ...
                    style={{
                      width: "75%",
                      background: "linear-gradient(90deg, var(--color-accent), var(--color-green2))",
